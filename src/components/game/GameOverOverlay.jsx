...
export default function GameOverOverlay({
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center pointer-events-none">
      <div className="pointer-events-auto w-full max-w-md rounded-2xl border border-cyan-400 bg-zinc-950/95 p-8 text-center shadow-[0_0_40px_rgba(34,211,238,0.25)]">
  ...
  <button
    ...
    className="rounded-md border border-cyan-400 bg-zinc-900 px-4 py-2 font-orbitron text-cyan-300 hover:bg-cyan-500/20"
  >
    Combat Log
  </button>
