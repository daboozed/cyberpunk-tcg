...
export const GEAR_POOL = [
  ...
  { id: 'g6', name: 'Dying Night', subtitle: "V's Pistol", type: 'gear', cost: 2, color: 'blue', tags: [TAGS.MILITECH], sellable: true, effect: 'Equip to a unit or face-up legend. ATTACK: If you have 7+ ★, defeat a rival Gear that costs 2 or less.', effectData: { type: 'GEAR_TRIGGER', trigger: 'onAttack', action: ['IF_STREET_CRED_7', 'CHOOSE_RIVAL_GEAR_MAX_COST_2', 'DEFEAT_SELECTED_RIVAL_GEAR'] }, powerBonus: 2, imageUrl: BASE_IMG + '697107581860bf853828ac13_a022.webp' },
